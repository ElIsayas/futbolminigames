...
import 'package:futbolminigames/screens/tictactoe_screen.dart'; // Importa la nueva pantalla.
...
class _MinigamesScreenState extends State<MinigamesScreen>
        ...
        children: [
          ...
          SafeArea(
            child: Column(
              ...
              children: [
                ...
                Column(children: [_buildMinigameButton('TICTACTOE')]),
          ...
          Positioned(
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.pop(context); // Vuelve a la anterior (dificultad).
              },
            ),
          ),
        ],
  ...
  Widget _buildMinigameButton(String text) {
    return Padding(
